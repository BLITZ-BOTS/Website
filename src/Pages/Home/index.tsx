...
import { FaRocket, FaTachometerAlt, FaServer, FaUsers } from 'react-icons/fa'; 
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen px-8 flex flex-col lg:flex-row items-start justify-center lg:h-screen overflow-hidden pt-0">
      {/* Main Title Section */}
      <div
        className={`text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-center lg:text-left space-y-4 lg:w-2/3 transition-all duration-1000 ease-out transform ${
      ...
      <div className="lg:w-2/3 grid grid-cols-2 gap-4 items-center justify-center mt-2">
